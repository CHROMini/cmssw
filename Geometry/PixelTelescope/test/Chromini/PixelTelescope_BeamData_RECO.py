...
opt.register('inputDir',  './run000299/',
...
opt.register('fileNames',  'file:/opt/sbg/cms/ui3_data1/cgrimaul/TelescopeData/run000299/PixelTelescope_BeamData_RAW.root',
	     opts.VarParsing.multiplicity.singleton, opts.VarParsing.varType.string,
	     'Input raw files')   
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(opt.fileNames),
    #fileNames = cms.untracked.vstring(
     # "file:/opt/sbg/cms/ui3_data1/cgrimaul/TelescopeData/run000299/PixelTelescope_BeamData_RAW.root"
    #),
...
process.DQMData = cms.EDAnalyzer('AnaChromini', 
